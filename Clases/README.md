# Clases
## Introduccion
Dentro de esta carpeta se encontraran todos los apuntes que se tomaron en las clases de la materia de Analisis de Datos con SQL.

Sedividiran por carpetas:
- Session1
- Session2
- Session3
- ...
...
- [Click aqui para ver la Session1](Session1/README.md)
